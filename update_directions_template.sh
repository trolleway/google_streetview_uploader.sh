...
mapillary_tools process --advanced --import_path "$PWD" --user_name $USERNAME --cutoff_distance 100  --interpolate_directions --offset_angle 180 --rerun --overwrite_EXIF_direction_tag
